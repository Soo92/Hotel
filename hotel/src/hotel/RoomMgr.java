	...
	public RoomBean getRoom(int index) {
		...
		try {
			...
			if (rs.next()) {
				...
				regBean.setSubpic1(rs.getString("subpic1"));
				regBean.setSubpic2(rs.getString("subpic2"));
				regBean.setSubpic3(rs.getString("subpic3"));
				regBean.setSubname(rs.getString("subname"));
				regBean.setSubcontent(rs.getString("subcontent"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
