...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./mypage_files/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    <style type="text/css">
...
.dropdown ul.dropdown-menu:before {
	...
	function modify(){
    document.getElementById("li2").innerHTML = "ID"+" : "+"<input type='text'   style='background-color:transparent'  value=' <%=bean.getId()%>'>";
    document.getElementById("li3").innerHTML = "Password"+" : "+"<input type='text'  style='background-color:transparent'   value=' <%=bean.getPass()%>'>";
    document.getElementById("li4").innerHTML = "Modify Your Profile" + "<button style='background-color:transparent;  margin-left: 1cm;' onclick='update()';>APPLY</button>";
    }
    </script>
